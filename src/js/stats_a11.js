$(document).ready(function () {
    ...
    function rom_stats() {
        ...
        const rom_list = ['aex', 'aicp', 'aosip', 'aospa', 'aospk', 'arrowos', 'awaken', 'bliss', 'carbon', 'cesium', 'cherish', 'cipheros', 'colt', 'corvus', 'crdroid', 'derp', 'descendant', 'dot', 'dotfe', 'evox', 'falcon', 'fluid', 'havoc', 'hycon', 'kang', 'komodo', 'legion', 'lighthouse', 'lineage', 'lineagefe', 'mokee', 'msm-xtended', 'nezuko', 'nusantara', 'octavi', 'palladium', 'pe', 'peplus', 'peext', 'pixysos', 'posp', 'radiant', 'revengeos', 'sakura', 'shapeshift', 'spark', 'spice', 'stag', 'styx', 'superior', 'tenx', 'wave', 'yaap'];
        for (let i = 0; i < 1; i++) {
            for (let j = 0; j < 50; j++) {
